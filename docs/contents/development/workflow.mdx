...
This guide outlines the recommended workflow for contributing to the Slack MCP Server project.
...
- Browse existing [GitHub Issues](https://github.com/Chisanan232/slack-mcp-server/issues) to find something to work on
...
1. Go to the [Slack MCP Server repository](https://github.com/Chisanan232/slack-mcp-server)
...
git remote add upstream https://github.com/Chisanan232/slack-mcp-server.git
...
<Tabs>
  ...
  <TabItem value="poetry" label="poetry">
    ...
    # Run with coverage report
    poetry run pytest --cov=slack_mcp_server
  ...
  <TabItem value="uv" label="uv">
    ...
    # Run with coverage report
    uv run pytest --cov=slack_mcp_server
...
- Ask questions in the [GitHub Discussions](https://github.com/Chisanan232/slack-mcp-server/discussions)
