...
Before you begin contributing to Slack MCP Server, ensure your development environment meets these requirements.
...
2. **Create a virtual environment**:
   ...
   <Tabs>
     ...
     ```bash
     conda create -n slack-mcp python=3.13
...
5. **Create a `.env` file for local development**:
   ```bash
   cp .env.example .env
   # Edit .env with your Slack API token
   ```
