...
The `validate_slack_event_types.yml` workflow automatically validates that our SlackEvent enum stays synchronized with the official Slack Events API specification.
