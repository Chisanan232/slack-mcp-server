...
[![GitHub release](https://img.shields.io/github/v/release/Chisanan232/slack-mcp-server?display_name=tag&color=24292e&logo=github)](https://github.com/Chisanan232/slack-mcp-server/releases)
...
[![PyPI version](https://img.shields.io/pypi/v/slack-mcp?label=PyPI&color=306998&logo=pypi)](https://pypi.org/project/slack-mcp/)
...
[![TestPyPI version](https://img.shields.io/badge/dynamic/json?label=TestPyPI&color=ff6600&query=%24.info.version&url=https%3A%2F%2Ftest.pypi.org%2Fpypi%2Fslack-mcp%2Fjson&logo=pypi)](https://test.pypi.org/project/slack-mcp/)
