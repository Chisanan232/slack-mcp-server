...
2. **Queue Backend** (from [abstract-backend](https://github.com/Chisanan232/abstract-backend) library) - Stores and distributes events to consumers
...
The queue backend abstraction layer has been migrated to the **[abstract-backend](https://github.com/Chisanan232/abstract-backend)** library. This library provides:

- **Unified Protocol Interface**: `MessageQueueBackend` protocol for all queue implementations
- **Built-in Backends**: Memory, Redis, Kafka, and more
...
**Please refer to the [abstract-backend documentation](https://chisanan232.github.io/abstract-backend/)**
:::
...
:::note Consumer Base Classes
The base consumer classes (`AsyncLoopConsumer`) have been migrated to the **[abstract-backend](https://github.com/Chisanan232/abstract-backend)** library.

For consumer implementation details, refer to the [abstract-backend consumer documentation](https://chisanan232.github.io/abstract-backend/).
:::
