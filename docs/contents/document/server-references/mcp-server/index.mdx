...
- 📋 [**Environment Configuration**](../environment-configuration.mdx) - Environment variables and authentication setup
- 🚀 [**Deployment Guide**](../deployment-guide.mdx) - Local, Docker, Kubernetes, and cloud deployment examples  
- 🔧 [**CLI Reference**](./cli-reference.mdx) - Complete command-line interface documentation
...
For detailed deployment options and usage examples, see [Server Modes](./server-modes.mdx).
...
For detailed transport configuration, see the [CLI Reference](./cli-reference.mdx).

## Available Tools

The following MCP tools are available for Slack integration:

- ✅ [**Post Message**](./end-points/slack_post_message.mdx) - Send text messages to Slack channels
- ✅ [**Read Channel Messages**](./end-points/slack_read_channel_messages.mdx) - Retrieve message history from channels
- ✅ [**Read Thread Messages**](./end-points/slack_read_thread_messages.mdx) - Retrieve messages from specific threads
- ✅ [**Thread Reply**](./end-points/slack_thread_reply.mdx) - Send replies to existing threads
- ✅ [**Read Emojis**](./end-points/slack_read_emojis.mdx) - Get all available workspace emojis
- ✅ [**Add Reactions**](./end-points/slack_add_reactions.mdx) - Add emoji reactions to messages
