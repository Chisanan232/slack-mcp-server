...
**⚙️ Workflows**: [`/.github/workflows/`](https://github.com/Chisanan232/Template-Python-UV-Project/tree/master/.github/workflows)  
**🔄 Reusable Workflows**: [Template Workflow Reference](https://chisanan232.github.io/Template-Python-UV-Project/dev/next/ci-cd/reusable-workflows)
...
- **Coverage Reporting**: [`rw_organize_test_cov_reports.yaml`](https://github.com/Chisanan232/Template-Python-UV-Project/blob/master/.github/workflows/rw_organize_test_cov_reports.yaml) - Standardized test coverage reporting and artifact organization

:::tip Explore More Workflows
The template repository provides additional workflows for release management, Docker operations, and documentation deployment. See the [complete workflow catalog](https://chisanan232.github.io/Template-Python-UV-Project/dev/next/ci-cd/reusable-workflows)
:::
...
- **✅ Comprehensive Documentation**: Detailed guides and examples at [Template Docs](https://chisanan232.github.io/Template-Python-UV-Project/dev/next/ci-cd)
...
> 📋 **Template Workflow**: [`rw_uv_run_test_with_multi_py_versions.yaml`](https://github.com/Chisanan232/Template-Python-UV-Project/blob/master/.github/workflows/rw_uv_run_test_with_multi_py_versions.yaml)
...
**Source**: [`Chisanan232/Template-Python-UV-Project/.github/workflows/rw_uv_run_test_with_multi_py_versions.yaml@master`](https://github.com/Chisanan232/Template-Python-UV-Project/blob/master/.github/workflows/rw_uv_run_test_with_multi_py_versions.yaml)
...
**Source**: [`Chisanan232/Template-Python-UV-Project/.github/workflows/rw_organize_test_cov_reports.yaml@master`](https://github.com/Chisanan232/Template-Python-UV-Project/blob/master/.github/workflows/rw_organize_test_cov_reports.yaml)
...
> 📋 **Template Workflow**: [`rw_organize_test_cov_reports.yaml`](https://github.com/Chisanan232/Template-Python-UV-Project/blob/master/.github/workflows/rw_organize_test_cov_reports.yaml)
...
:::note Template Workflows Used
[`rw_uv_run_test_with_multi_py_versions.yaml`](https://github.com/Chisanan232/Template-Python-UV-Project/blob/master/.github/workflows/rw_uv_run_test_with_multi_py_versions.yaml) • [`rw_organize_test_cov_reports.yaml`](https://github.com/Chisanan232/Template-Python-UV-Project/blob/master/.github/workflows/rw_organize_test_cov_reports.yaml)
:::
