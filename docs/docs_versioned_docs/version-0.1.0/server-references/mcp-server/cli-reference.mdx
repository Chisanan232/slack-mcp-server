...
<Tabs>
  ...
  python -m slack_mcp.mcp --log-level warning
  ```
  </TabItem>
  <TabItem value="poetry" label="Poetry">
  ```bash
...
<Tabs>
  ...
  ```bash
  # CLI argument is used as fallback (if not in .env file)
  python -m slack_mcp.mcp --slack-token "xoxb-your-token-here"
  
  # Disable .env file loading to force CLI argument usage
  python -m slack_mcp.mcp --slack-token "xoxb-your-token-here" --no-env-file
  ...
  <TabItem value="poetry" label="Poetry">
  ```bash
  # CLI argument is used as fallback
  poetry run slack-mcp-server --slack-token "xoxb-your-token-here"
  ...
  ```bash
  # CLI argument is used as fallback
  uv run slack-mcp-server --slack-token "xoxb-your-token-here"
...
<Tabs>
  ...
  # Specify custom environment file
  python -m slack_mcp.mcp --env-file .env.production
  ```
  </TabItem>
  <TabItem value="poetry" label="Poetry">
  ```bash
  # Development environment
  poetry run slack-mcp-server --env-file .env.development
  
  # Production environment
  poetry run slack-mcp-server --env-file .env.production
  ```
  </TabItem>
  <TabItem value="uv" label="UV">
  ```bash
  # Development environment
  uv run slack-mcp-server --env-file .env.development
...
<Tabs>
  ...
  ```bash
  # Disable .env file loading
  python -m slack_mcp.mcp --no-env-file --slack-token "xoxb-your-token"
  ```
  </TabItem>
  <TabItem value="poetry" label="Poetry">
  ```bash
  # Disable .env file loading
  poetry run slack-mcp-server --no-env-file --slack-token "xoxb-your-token"
  ```
  </TabItem>
  <TabItem value="uv" label="UV">
  ```bash
  # Disable .env file loading
  uv run slack-mcp-server --no-env-file --slack-token "xoxb-your-token"
  ```
  </TabItem>
</Tabs>
...
For more detailed configuration options, see [Environment Configuration](../environment-configuration.mdx).
For deployment examples using these CLI options, see [Deployment Guide](../deployment-guide.mdx).
