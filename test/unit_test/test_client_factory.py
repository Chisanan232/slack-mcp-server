...
from slack_mcp.model import _BaseInput, SlackPostMessageInput, SlackThreadReplyInput
...
class TestDefaultSlackClientFactory:
    ...
    @pytest.mark.parametrize("input_class,expected_attributes", [
...
class TestRetryableSlackClientFactory:
    ...
    def test_custom_handler_inclusion(self):
        ...
        factory = RetryableSlackClientFactory(
            include_rate_limit_retries=True,
            include_server_error_retries=False,
            include_connection_error_retries=False
        )
