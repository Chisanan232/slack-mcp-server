...
class DecoratorHandler(EventHandler):
    ...
    @overload
    def __call__(self, ev: SlackEvent) -> Callable[[F], F]: ...
    ...
    def __getattr__(self, name: str) -> Callable[[F], F]:
